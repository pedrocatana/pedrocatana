...
os.system("start chrome.exe --new-window https://apphorarios.pt/assets/TGEIO22.png")
time.sleep(1)
pyautogui.press("F11")
...
pyautogui.press("left")
pyautogui.keyUp("win")
os.system("start chrome.exe --new-window https://apphorarios.pt/assets/TGEIO21.png")
time.sleep(1)
pyautogui.press("F11")
pyautogui.keyDown("win")
pyautogui.press("left")
pyautogui.keyUp("win")
os.system("start chrome.exe --new-window https://apphorarios.pt/assets/TGEIO20.png")
time.sleep(1)
pyautogui.press("F11")
pyautogui.keyDown("win")
pyautogui.press("left")
